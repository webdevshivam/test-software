...
<head>
    <meta charset="UTF-8">
    <title><?= esc($title ?? 'MegaStar Premier Cricket League (MPCL)') ?></title>
...
<header class="bg-slate-900 text-white">
    <div class="max-w-5xl mx-auto flex items-center justify-between px-4 py-3">
        <div class="flex items-center space-x-2">
            ...
            <div>
                <div class="font-semibold tracking-tight">MegaStar Premier Cricket League</div>
                <div class="text-xs text-slate-300">(MPCL) · Player Registration</div>
            </div>
        </div>
...
<footer class="border-t border-slate-200 mt-10">
    <div class="max-w-5xl mx-auto px-4 py-4 text-xs text-slate-500 flex items-center justify-between">
        <span>© <?= date('Y') ?> MegaStar Premier Cricket League (MPCL)</span>
